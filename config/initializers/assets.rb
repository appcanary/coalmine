...
Rails.application.config.assets.precompile += %w( application.css application.js launchrock.css launchrock.js greatreview.css isitvuln.js admin.js email.css rubysec.css rubysec.js)
