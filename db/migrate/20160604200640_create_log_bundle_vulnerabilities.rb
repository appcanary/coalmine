class CreateLogBundleVulnerabilities < ActiveRecord::Migration
  def change
    ...
    add_index :log_bundle_vulnerabilities, [:bundle_id, :package_id, :bundled_package_id, :vulnerability_id, :vulnerable_dependency_id, :vulnerable_package_id], unique: true, name: "index_of_six_kings_LBV"
  end
end
