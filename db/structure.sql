...
--
-- Name: index_server_tags_on_tag_and_agent_server_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_server_tags_on_tag_and_agent_server_id ON server_tags USING btree (tag, agent_server_id);
...
INSERT INTO schema_migrations (version) VALUES ('20170217190718');
