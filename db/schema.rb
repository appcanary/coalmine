...
ActiveRecord::Schema.define(version: 20160728213552) do
  ...
  create_table "agent_heartbeats", force: :cascade do |t|
    t.integer  "agent_server_id", null: false
    t.text     "files"
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
  end
  ...
  create_table "agent_received_files", force: :cascade do |t|
  ...
  add_index "agent_received_files", ["account_id"], name: "index_agent_received_files_on_account_id", using: :btree
  add_index "agent_received_files", ["agent_server_id"], name: "index_agent_received_files_on_agent_server_id", using: :btree
  ...
  add_foreign_key "agent_received_files", "accounts"
  add_foreign_key "agent_received_files", "agent_servers"
