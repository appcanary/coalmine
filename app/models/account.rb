...
class Account < ActiveRecord::Base
  ...
  has_many :email_patcheds # don't need dependent destroy for the next three as they're subclasses
  has_many :email_vulnerables
  has_many :email_daily_summaries
  has_many :patched_notifications, :through => :email_patcheds, :source => :notifications, :dependent => :destroy
  has_many :vulnerable_notifications, :through => :email_vulnerables, :source => :notifications, :dependent => :destroy
